...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "jOYtWoz1eeyJjqMVg2Vb7Qaw2";       // Change this
	public static final String REST_CONSUMER_SECRET = "Qu4YYu6NGtHuK2Orn5eCCLck9JQCBIHXnaVem0gUxAnbvTqoTq"; // Change this
	...
	public void postReplyToStatus(AsyncHttpResponseHandler handler, String tweet,
			String status_id){
		String apiUrl = getApiUrl("statuses/update.json");
		RequestParams params = new RequestParams();
		params.put("status", tweet);
